...
def shock_analysis(nL, analysis, ML_iot_coeff_0, multi_indices_agg, multi_indices, agg_level, rect_level):
    """
    ...
    from pySUT.applications.SA.perturbations import SA_delta_dict
    from pySUT.applications.SA.shocked_matrices import calc_A_s, calc_w_s, calc_m_s, calc_B_s, calc_Y_s
    from pySUT.applications.SA.leontief_models import calc_L_1, calc_Y_tot_1, calc_x_1, calc_R_1, calc_E_1
    from pySUT.applications.tables_recalc import calc_Z_1, calc_W_1, calc_M_1, ML_iot_1
    
    ML_delta_coeff = SA_delta_dict(nL, multi_indices_agg, agg_level, rect_level)
